    ...
    setWaiting(true);
        setTimeout(() => {
            if (
                ...
                setemailerror(
                    `We are sorry, only emails from the following domains are allowed: ${allowedDomains
                        .map((domain) => `@${domain}`)
                        .join(", ")}`
                );
            ...
            function handSubmit(e) {
                ...
                //             const info = {
                //                 pass: true,
                //                 data: { name: response.data.username, email: user.email },
                //             };
                //             userAuth.setAuthor(info);
                //             navigate("/user/dashboard", {
                //                 state: { isP: "yes", name: response.data.username },
                //             });
                //         })
                //         .catch((err) => {
                //             console.log(err);
                        ...
                        <div className="container">
                            <div className="box">
                                <div className="left">
                                    ...
                                    <p className="text">
                                        You can enter your account from here , just enter your information
                                    </p>
                            ...
                            {passworderror ? <p className="errore">{passworderror}</p> : null} */}
                                    {/* <button style={{ minHeight: "46px" }} type="submit">
                                {" "}
